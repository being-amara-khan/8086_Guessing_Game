;GUESSING GAME
;------------------------------------------------------------------------------------------
;1. THE PROGRAM WILL GENERATE THE RANDOM NUMBER BETWEEN 1 AND 255 WITHOUT -
;   DISPLYAING TO THE SCREEN
;2. THE PROGRAM WILL ASK THE USER TO INPUT THE GUESSED NUMBER
;3. THE USER WILL INPUT THE GUESSED NUMBER (IT SHOULD BE BETWEEN 1 AND 255>
;4. THE PROGRAM WILL SHOW THE RESULT OF THE GUESSING WHETHER THE VALUE IS -
;   MORE, LESS, ERROR, OR RIGHT ANSWER
;------------------------------------------------------------------------------------------
.model small                   
.stack 1000h
.data
...
while:
    ...
    CMP     CL, 3d                  ; compare CL with 10d (5 is the maximum number of digits allowed)
    ...
    JMP while
                ; JUMP back to label 'while' if reached                
